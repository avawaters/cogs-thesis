...
//EDIT EACH GEN
var low_stimuli = ["stimuli/low/seed_1p-gen_2-low.mp3", "stimuli/low/seed_2p-gen_2-low.mp3", "stimuli/low/seed_3p-gen_2-low.mp3", "stimuli/low/seed_4p-gen_2-low.mp3"];
...
//EDIT EACH GEN
var high_stimuli = ["stimuli/high/seed_1p-gen_2-high.mp3", "stimuli/high/seed_2p-gen_2-high.mp3", "stimuli/high/seed_3p-gen_2-high.mp3", "stimuli/high/seed_4p-gen_2-high.mp3"];


// capture info from Prolific
const subject_id = jsPsych.data.getURLVariable('PROLIFIC_PID');
//EDIT EACH GEN
const fname = `gen_2-${subject_id}.json`;
...
var pitch_matching_response = {
    ...
    on_finish: function (data) {
        ...
        //EDIT EACH GEN
        const filename = `gen_2-${subject_id}-${data.pitch}.webm`;
...
var trial_response = {
    ...
    on_finish: function (data) {
        ...
        //EDIT EACH GEN
        const filename = `gen_2-${subject_id}-${data.melody}.webm`;
        jsPsychPipe.saveBase64Data("QfKXr6jPLyzT", filename, data.response);
    }
};
